...
维护人：Hermes小助理
审核人：未审核
文件路径：技能包库/图片处理/外观设计专利相似度分析技能包_v1.md
---

---
name: ecommerce.design-patent-analyzer
version: 1.0.0
description: |
...
|--------|----------|------|
| Zhihuiya | `/api/v1/tools/research/zhihuiya/patentImageSearch` (model=1) | Smart association — similar designs by appearance |
| Zhihuiya | `/api/v1/tools/research/zhihuiya/patentImageSearch` (model=2) | Exact match — shape and pattern-based matches |
