...
维护人：Hermes小助理
审核人：未审核
文件路径：技能包库/亚马逊运营/价格历史分析技能包_v1.md
---

---
name: ecommerce.price-history-analyzer
version: 1.1.0
description: |
...
|--------|----------|------|
| Keepa | `/api/v1/tools/research/keepa/productSeries` | Buy Box history, BSR, ratings, monthly sold |
| NexScope Proxy | `/api/v1/tools/research/amazon/search` | Current product list |
