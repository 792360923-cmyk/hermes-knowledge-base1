...
维护人：Hermes小助理
审核人：未审核
文件路径：技能包库/关键词分析/关键词机会发现技能包_v1.md
---

---
name: ecommerce.keyword-opportunity-finder
version: 1.4.0
description: |
...
| Amazon Search | `/api/v1/tools/research/amazon/search` | Competition density, product count |
