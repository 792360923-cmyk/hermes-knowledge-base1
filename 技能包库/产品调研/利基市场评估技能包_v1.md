...
维护人：Hermes小助理
审核人：未审核
文件路径：技能包库/产品调研/利基市场评估技能包_v1.md
---

---
name: ecommerce.niche-evaluator
version: 3.1.0
description: |
...
| Google Trends | `/api/v1/tools/research/googleTrend/getTrendByKeys` | Trend momentum validation |
...
| TikTok Echotik | `/api/v1/tools/research/echotik/listProduct` | Social commerce trend signals |
