...
维护人：Hermes小助理
审核人：未审核
文件路径：技能包库/产品调研/产品验证技能包_v1.md
---

---
name: ecommerce.product-validator
version: 1.4.0
description: |
...
|--------|----------|------|
| Keepa | `/api/v1/tools/research/keepa/productRequest` | Product details, title, price, reviews, BSR |
