...
维护人：Hermes小助理
审核人：未审核
文件路径：技能包库/产品调研/市场全景概览技能包_v1.md
---
...
|--------|----------|------|
| Amazon Search | `/api/v1/tools/research/amazon/search` | Products, prices, reviews, BSR |
| eBay Search | `/api/v1/tools/research/ebay/search` | Cross-platform pricing |
| Walmart Search | `/api/v1/tools/research/walmart/search` | Multi-channel comparison |
| Jungle Scout | `/api/v1/tools/jungle-scout/keywords/share-of-voice` | Search volume, brand SOV |
| ABA (Amazon Brand Analytics) | `/api/v1/tools/research/aba/intelligentQuery` | Search Frequency Rank |
| TikTok Echotik | `/api/v1/tools/research/echotik/listProduct` | Social commerce signals |
| Keepa | `/api/v1/tools/research/keepa/productSeries` | Historical BSR, price trends |
