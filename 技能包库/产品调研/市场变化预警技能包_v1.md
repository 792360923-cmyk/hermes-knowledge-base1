...
维护人：Hermes小助理
审核人：未审核
文件路径：技能包库/产品调研/市场变化预警技能包_v1.md
---

---
name: ecommerce.market-alert
version: 3.0.0
description: |
...
|--------|----------|------|
| Amazon Search (SerpApi) | `/api/v1/tools/research/amazon/search` | Product list ranked by relevance, monthly sales |
| Jungle Scout | `/api/v1/tools/jungle-scout/keywords/by-keyword` | Search volume, keyword trends |
| Keepa | `/api/v1/tools/research/keepa/productRequest` | `availableDate` for new competitor detection |
