...
|--------|----------|------|
| TikTok Echotik | `/api/v1/tools/research/echotik/listProduct` | Hot products, sales velocity |
| Google Trends | `/api/v1/tools/research/googleTrend/getTrendByKeys` | Search interest over time |
| Amazon Search | `/api/v1/tools/research/amazon/search` | Product listings, competition |
