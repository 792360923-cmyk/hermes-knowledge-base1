...
维护人：Hermes小助理
审核人：未审核
文件路径：技能包库/产品调研/专利法律状态查询技能包_v1.md
---
...
|--------|----------|------|
| Zhihuiya | `/api/v1/tools/research/zhihuiya/legalStatus` | Simple status, detailed status, legal events |
| Zhihuiya | `/api/v1/tools/research/zhihuiya/simpleBibliography` | Patent title, type, country |
