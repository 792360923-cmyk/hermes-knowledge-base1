...
维护人：Hermes小助理
审核人：未审核
文件路径：技能包库/产品调研/市场份额分析技能包_v1.md
---

---
name: ecommerce.market-share-analyzer
version: 2.0.0
description: |
...
| Amazon Search | `/api/v1/tools/research/amazon/search` | Product list, prices, reviews |
| Keepa | `/api/v1/tools/research/keepa/productRequest` | Product details, monthly sales, seller info |
| Keepa | `/api/v1/tools/research/keepa/productSeries` | BSR history, price trends |
