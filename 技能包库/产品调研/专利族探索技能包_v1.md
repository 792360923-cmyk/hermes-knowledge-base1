...
|--------|----------|------|
| Zhihuiya | `/api/v1/tools/research/zhihuiya/patentFamily` | Patent family members (Simple, INPADOC, PatSnap) |
| Zhihuiya | `/api/v1/tools/research/zhihuiya/legalStatus` | Legal status of each family member |
