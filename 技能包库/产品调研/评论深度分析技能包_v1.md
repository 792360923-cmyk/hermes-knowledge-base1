...
维护人：Hermes小助理
审核人：未审核
文件路径：技能包库/产品调研/评论深度分析技能包_v1.md
---
...
|--------|----------|------|
| Amazon | `/api/v1/tools/research/amazon/search` | Products with review counts |
| Amazon | `/api/v1/tools/research/amazon/usReviewsList` | **US market review content** |
| Amazon | `/api/v1/tools/research/amazon/reviews/list` | **Non-US review content** (with `domainCode`) |
...
| Japan | co.jp | ✅ |
| Australia | com.au | ✅ |
| **US** | — | ✅ Supported (via `/api/v1/tools/research/amazon/usReviewsList`) |

**Note:** US market uses a dedicated API endpoint `/api/v1/tools/research/amazon/usReviewsList`. Non-US markets use `/api/v1/tools/research/amazon/reviews/list` with the appropriate `domainCode`.
...
- US market supported via dedicated `/api/v1/tools/research/amazon/usReviewsList` endpoint
