...
维护人：Hermes小助理
审核人：未审核
文件路径：技能包库/产品调研/需求真实性验证技能包_v1.md
---

---
name: ecommerce.demand-validator
version: 1.0.0
description: |
...
| Amazon Search | `/api/v1/tools/research/amazon/search` | Products with sales estimates |
| ABA (Amazon Brand Analytics) | `/api/v1/tools/research/aba/intelligentQuery` | SFR 12-week trend + Top 3 Click Share (2 queries) |
| eBay | `/api/v1/tools/research/ebay/search` (showOnly: Sold) | Cross-platform sold listings validation |
| TikTok Echotik | `/api/v1/tools/research/echotik/listProduct` | Social commerce demand signals |
| Keepa | `/api/v1/tools/research/keepa/productSeries` | BSR history, seasonality, seller count trends |
