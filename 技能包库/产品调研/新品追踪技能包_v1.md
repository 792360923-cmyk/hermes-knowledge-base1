...
|--------|----------|------|
| Amazon Search | `/api/v1/tools/research/amazon/search` | Product list, sales estimates |
| Keepa | `/api/v1/tools/research/keepa/productSeries` | BSR history, listing age |
