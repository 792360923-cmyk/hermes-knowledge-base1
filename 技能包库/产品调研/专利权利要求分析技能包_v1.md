...
维护人：Hermes小助理
审核人：未审核
文件路径：技能包库/产品调研/专利权利要求分析技能包_v1.md
---

---
name: ecommerce.patent-claim-analyzer
version: 1.0.0
description: |
...
|--------|----------|------|
| Zhihuiya | `/api/v1/tools/research/zhihuiya/claimData` | Original claim text |
| Zhihuiya | `/api/v1/tools/research/zhihuiya/claimDataTranslated` | Translated claims (cn/en/jp) |
| Zhihuiya | `/api/v1/tools/research/zhihuiya/simpleBibliography` | Patent title, type, country context |
