...
维护人：Hermes小助理
审核人：未审核
文件路径：技能包库/产品调研/专利风险报告生成技能包_v1.md
---

---
name: ecommerce.patent-report-generator
version: 1.0.0
description: |
...
|--------|----------|------|
| Zhihuiya | `/api/v1/tools/research/zhihuiya/patentImageSearch` (Design, model=1) | Design patent visual similarity |
| Zhihuiya | `/api/v1/tools/research/zhihuiya/patentImageSearch` (Utility, model=4) | Utility patent image similarity |
| Zhihuiya | `/api/v1/tools/research/zhihuiya/legalStatus` | Legal status and litigation events |
| Zhihuiya | `/api/v1/tools/research/zhihuiya/patentFamily` | Family coverage across countries |
| Zhihuiya | `/api/v1/tools/research/zhihuiya/claimDataTranslated` | Translated claims for top-risk patents |
