...
维护人：Hermes小助理
审核人：未审核
文件路径：技能包库/产品调研/产品差异化建议技能包_v1.md
---
...
|--------|----------|---------|
| NexScope Proxy | `/api/v1/tools/research/amazon/search` | Find competitors |
| NexScope Proxy | `/api/v1/tools/research/amazon/reviews/list` | Review content (non-US) |
| NexScope Proxy | `/api/v1/tools/research/amazon/usReviewsList` | Reviews for US market |
